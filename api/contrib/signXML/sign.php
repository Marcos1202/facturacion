...
function signFE()
{
    ...
    //$p12Url     = filesGetUrl('C:\Users\Marcos\Downloads\080133093601.p12'); //filesGetUrl(params_get('p12Url'));
    //$p12Url     = 'C:\Users\Marcos\Downloads\certificados\310106444209.p12'; //filesGetUrl(params_get('p12Url'));
    $pinP12     = params_get('pinP12');
    $inXml      = params_get('inXml');
    $tipoDoc    = params_get('tipodoc');
    $tipos      = array("FE", "ND", "NC", "TE","CCE","CPCE","RCE");
    //return  'C:\Users\Marcos\Downloads';
