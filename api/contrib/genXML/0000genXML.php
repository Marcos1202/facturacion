...
function genXMLFe()
{
    ...
    //return "Hola";
    $xmlString = '<?xml version="1.0" encoding="utf-8"?><FacturaElectronica xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="https://cdn.comprobanteselectronicos.go.cr/xml-schemas/v4.3/facturaElectronica">
        <Clave>' . $clave . '</Clave>
...
/*}*/
    ...
    foreach ($detalles as $d)
    {
        ...
        {
            //$xmlString .= '<BaseImponible>' . '1000.00000' . '</BaseImponible>';
        ...
        /* TEST */
                ...
                <Impuesto>
                    ...
                    $xmlString .= '<CodigoTarifa>' . '01' . '</CodigoTarifa>';
                    
              
                    $xmlString .= '<Tarifa>' .'0' . '</Tarifa>';
                
               
                    //$xmlString .= '<FactorIVA>' . $i->factorIVA . '</FactorIVA>';
                
                $xmlString .= '<Monto>' . '0' . '</Monto>';
